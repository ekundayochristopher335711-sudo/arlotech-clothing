          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-10 gap-x-8">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="flex items-center gap-4">
                <a href="#" aria-label="Instagram" className="text-[#aaa] hover:text-black transition-colors">
                ...
                <a href="#" aria-label="Twitter" className="text-[#aaa] hover:text-black transition-colors">
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="#" aria-label="TikTok" className="text-[#aaa] hover:text-black transition-colors">
            ...
            {/* Spacer on desktop to keep 4-col alignment */}
